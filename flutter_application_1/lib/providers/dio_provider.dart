...
//store booking details
  Future<dynamic> bookAppointment(String date, String day, String time,
      int beautycenter, String token) async {
    try {
  ...
  Future<dynamic> storeReviews(String reviews, double ratings, int id,
      int beautycenter, String token) async {
    try {
  ...
  //store fav beautycenter
  //update the fav list into database
  Future<dynamic> storeFavBc(String token, List<dynamic> favList) async {
    try {
