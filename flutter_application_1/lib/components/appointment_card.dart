...
class AppointmentCard extends StatefulWidget {
  AppointmentCard({Key? key, required this.beautycenter, required this.color})
      : super(key: key);
              ...
              Row(
                children: [
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Text(
                        'BC ${widget.beautycenter['beautycenter_name']}',
                        ...
                        showDialog(
                            ...
                            builder: (context) {
                              return RatingDialog(
                                  ...
                                  message: const Text(
                                    'Please help us to rate our Beauty Center',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: 15,
                                    ),
                                  ...
                                  onSubmitted: (response) async {
                                    ...
                                    final rating = await DioProvider()
                                        .storeReviews(
                                            response.comment,
                                            response.rating,
                                            widget.beautycenter['appointments']
                                                ['id'], //this is appointment id
                                            widget.beautycenter[
                                                'bc_id'], //this is beautycenter id
                                            token);
